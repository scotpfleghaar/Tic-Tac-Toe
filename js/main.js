...
(function () {
    ...
    $(".board").before('<div class="screen screen-start" id="start"><header><h1>Tic Tac Toe</h1><div class="twoPlayerOptions"><a href="#" style="margin: 2%;" class="button startButton newGame notSelected">Start game</a><br><br><br><p>Optional:</p>Player One: <input type="text" class="playerOneName"><br><br>Player Two: <input type="text" class="playerTwoName"><br></div></header</div>');
    ...
    //    (function () {
    $(".box, .newGame").on("click", function () { //This allows the start click to set the player to be fully active.
        ...
        if ($(this).hasClass("notSelected")) {
            ...
            //AI Goes here
            //Lets Start Random
            //        // Math.floor(Math.random() * 6) //Random between 0 and 6
            //        if ($(".player2").hasClass('active')) {
            //
            //            setTimeout(function () {
            //                $('.box-5').click();
